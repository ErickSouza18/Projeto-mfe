...
const AddCompanyModal: React.FC<AddCompanyModalProps> = ({ onClose, onAddCompany }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
      <div 
        className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-xl max-h-[90vh] overflow-auto animate-slide-in"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="p-6">
          <h2 className="text-2xl font-bold text-center mb-6 dark:text-white">{t('company.add.title')}</h2>
          ...
          <div className="flex border-b border-gray-200 dark:border-gray-700 mb-6">
            ...
            >
              {t('company.add.authenticate')}
            </button>
          </div>
          
          {activeTab === 'cadastrar' && (
            <>
              <h3 className="text-xl font-semibold mb-1 dark:text-white">{t('company.add.registerCompany')}</h3>
              <p className="text-gray-500 dark:text-gray-400 text-sm mb-6">{t('company.add.registerDesc')}</p>
              
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="flex items-start gap-3">
                  <div className="flex-shrink-0 w-8 h-8 mt-2 bg-gray-100 dark:bg-gray-700 rounded-lg flex items-center justify-center">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="dark:text-gray-300">
                  ...
                  <IconInput
                    ...
                    type="text"
                    name="name"
                    placeholder={t('company.add.name')}
                    value={formData.name}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <IconInput
                    ...
                    type="email"
                    name="email"
                    placeholder={t('company.add.email')}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <IconInput
                    ...
                    type="tel"
                    name="phone"
                    placeholder={t('company.add.phone')}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <IconInput
                    ...
                    placeholder={t('company.add.responsible')}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <IconInput
                    ...
                    type="number"
                    name="employeeCount"
                    placeholder={t('company.add.employees')}
          ...
          {activeTab === 'autenticar' && (
            <div className="flex flex-col items-center justify-center py-8">
              <p className="text-gray-600 dark:text-gray-300 mb-6 text-center">
                {t('company.add.authenticateDesc')}
              </p>
